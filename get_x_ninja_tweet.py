...
def searchWordsRecurrent(req,from_date, to_date):
    url = "https://api.twitter.com/1.1/tweets/search/fullarchive/MyPortfolio.json"
    keyword = "Ma_gician"
    print('----------------------------------------------------')
    params = {'query' : keyword, 'maxResults' : 100,'fromDate':from_date,'toDate':to_date, 'next':req['next']}
    ...
    if 'next' in search_timeline:
        searchWordsRecurrent(search_timeline,from_date, to_date)
...
def searchWords(from_date, to_date):
    ...
    if req.status_code == 200:
        ...
        print("ERROR: %d" % req.status_code)
    if 'next' in search_timeline:
        searchWordsRecurrent(search_timeline,"201906010000", "201907010000")
...
if __name__ == '__main__':
    ...
    searchWords("201906010000", "201907010000")
